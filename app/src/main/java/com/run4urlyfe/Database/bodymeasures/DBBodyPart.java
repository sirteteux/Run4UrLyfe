...
public class DBBodyPart extends DBBase {
    ...
    public DBBodyPart(Context context) {
        super(context);
    }
    ...
    public long add(int pBodyPartId, String pCustomName, String pCustomPicture, int pDisplay, int pType) {
        ...
        value.put(DBBodyPart.BODYPART_RESID, pBodyPartId);
        ...
        long new_id = db.insert(DBBodyPart.TABLE_NAME, null, value);
    ...
    public int update(BodyPart m) {
        ...
        ContentValues value = new ContentValues();
        value.put(DBBodyPart.BODYPART_RESID, m.getBodyPartResKey());
        value.put(DBBodyPart.CUSTOM_NAME, m.getCustomName());
        value.put(DBBodyPart.CUSTOM_PICTURE, m.getCustomPicture());
        value.put(DBBodyPart.DISPLAY_ORDER, m.getDisplayOrder());
        value.put(DBBodyPart.TYPE, m.getType());
