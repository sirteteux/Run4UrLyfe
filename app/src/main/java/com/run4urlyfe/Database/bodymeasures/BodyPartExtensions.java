...
public class BodyPartExtensions {
    ...
    public static int getBodyStringID(int pBodyID) {
        switch (pBodyID) {
            case ABDOMINALS:
                return R.string.abdominals;
            case THIGHS:
                return R.string.thighs;
            case BICEPS:
