...
public class ProfileFragment extends Fragment {
    ...
    private DBProfile daoProfile = null;
    private DBBodyMeasure DBBodyMeasure = null;
    private DBBodyPart DBBodyPart = null;
    ...
    private final OnClickListener mOnClickListener = view -> {
        ...
        if (view.getId() == R.id.size) {
                BodyPart sizeBodyPart = DBBodyPart.getBodyPartfromBodyPartKey(BodyPartExtensions.SIZE);
                BodyMeasure lastSizeValue = DBBodyMeasure.getLastBodyMeasures(sizeBodyPart.getId(), appViMo.getProfile().getValue());
                ...
                editorDialogbox.setOnDismissListener(dialog -> {
                    if (!editorDialogbox.isCancelled()) {
                        ...
                        DBBodyMeasure.addBodyMeasure(date, sizeBodyPart.getId(), value, appViMo.getProfile().getValue().getId(), unit);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        daoProfile = new DBProfile(view.getContext());
        DBBodyMeasure = new DBBodyMeasure(view.getContext());
        DBBodyPart = new DBBodyPart(view.getContext());
    ...
    private void updateProfileViMo(Profile profile) {
        ...
        BodyMeasure sizeMeasure = DBBodyMeasure.getLastBodyMeasures(BodyPartExtensions.SIZE, profile);
        if (sizeMeasure!=null) {
