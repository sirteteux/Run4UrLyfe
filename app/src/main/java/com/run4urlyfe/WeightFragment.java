...
import com.run4urlyfe.Database.DBProfileWeight;
...
public class WeightFragment extends Fragment {
    private final DBProfile mDb = null;
    ...
    private DBProfileWeight mWeightDb = null;
    private DBBodyMeasure mDbBodyMeasure = null;
    ...
    /**
     * Create a new instance of WeightFragment, initialized to
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWeightDb = new DBProfileWeight(view.getContext());
        mDbBodyPart = new DBBodyPart(view.getContext());
        mDbBodyMeasure = new DBBodyMeasure(view.getContext());
